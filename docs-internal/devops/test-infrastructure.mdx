...
jobs:
  run-tests:
    ...
    - run: # ...
      env:
        COSMOSDB__CONNECTIONSTRING: ${{ steps.terraform-apply.outputs.cosmosdb_connection_string }}
...
Apply the Terraform Script to ensure, the Test Infrastructure matches the desired state.
